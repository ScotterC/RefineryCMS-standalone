# module Admin
  class Refinery::Admin::DashboardController < Refinery::Admin::BaseController
    ...
    def index
      ...
      @recent_activity = @recent_activity.flatten.compact.sort { |x,y| y.updated_at <=> x.updated_at }.first(activity_show_limit=RefinerySetting.find_or_set(:activity_show_limit, 7))
